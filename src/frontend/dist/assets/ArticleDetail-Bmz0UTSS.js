import { r as reactExports, j as jsxRuntimeExports, b as useParams, L as Link, S as Skeleton } from "./index-BgVkh6qM.js";
import { C as CategoryBadge } from "./CategoryBadge-CgY9QkkO.js";
import { c as createLucideIcon, g as useArticleBySlug, h as useIncrementViewCount, d as useListArticles, i as SortBy, A as ArticleStatus, L as Layout, E as Eye } from "./useArticles-C4geP0DZ.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-4/5" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-4", children: [
              [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full" }, i)),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-3/4" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden lg:block w-72 shrink-0 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-36 mb-4" }),
            [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 w-full rounded-lg" }, i))
          ] })
        ] })
      ]
    }
...
function RelatedArticleCard({ article }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        article.featuredImageUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryBadge, { category: article.category, className: "mb-2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground leading-snug line-clamp-2 group-hover:text-primary transition-colors", children: article.title }),
...
function ArticleDetail() {
  ...
  const hasIncrementedRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
    if ((article == null ? void 0 : article.id) !== void 0 && !hasIncrementedRef.current) {
      hasIncrementedRef.current = true;
      incrementViewCount.mutate(article.id);
    }
  }, [article == null ? void 0 : article.id]);
  const relatedArticles = ((relatedResult == null ? void 0 : relatedResult.articles) ?? []).filter((a) => a.slug !== slug).slice(0, 4);
  const publishDate = article ? new Date(article.publishDate).toLocaleDateString("en-US", {
    month: "long",
    day: "numeric",
    year: "numeric"
  }) : "";
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArticleDetailSkeleton, {}) });
  }
  if (!article) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-12 h-12 text-muted-foreground mx-auto mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground mb-2", children: "Article Not Found" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "The article you're looking for doesn't exist or has been removed." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.article,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryBadge, { category: article.category }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h1",
                {
              ...
              article.featuredImageUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 rounded-xl overflow-hidden border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: article.featuredImageUrl,
                  alt: article.title,
              ...
              article.excerpt && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground italic border-l-4 border-primary/60 pl-4 mb-8", children: article.excerpt }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
        ...
        relatedArticles.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "aside",
          {
            className: "hidden lg:block w-72 shrink-0",
            "data-ocid": "related.section",
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4", children: "Related Articles" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: relatedArticles.map((rel, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  initial: { opacity: 0, x: 12 },
                  animate: { opacity: 1, x: 0 },
                  transition: { delay: idx * 0.08, duration: 0.35 },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(RelatedArticleCard, { article: rel })
                },
                rel.slug
              )) })
            ] })
      ...
      relatedArticles.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          className: "lg:hidden mt-12 pt-10 border-t border-border",
          "data-ocid": "related.section-mobile",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-bold text-foreground mb-5", children: "Related Articles" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: relatedArticles.map((rel) => /* @__PURE__ */ jsxRuntimeExports.jsx(RelatedArticleCard, { article: rel }, rel.slug)) })
          ]
        }
      )
    ] })
