import { r as reactExports, j as jsxRuntimeExports, R as ReactDOM, c as cn, e as reactDomExports, d as ue, a as useNavigate, S as Skeleton, L as Link } from "./index-BgVkh6qM.js";
import { c as createLucideIcon, u as useComposedRefs, X, l as useCreateArticle, m as useUpdateArticle, n as Category, A as ArticleStatus, I as Input, C as CATEGORIES, a as CATEGORY_LABELS, B as Button, j as useAdmin, o as buttonVariants, p as Slot$2, q as cva, d as useListArticles, r as useDeleteArticle, s as useAdminLogout, L as Layout, E as Eye, i as SortBy } from "./useArticles-C4geP0DZ.js";
import { f as useCallbackRef$1, P as Primitive, c as composeEventHandlers, h as dispatchDiscreteCustomEvent, i as useLayoutEffect2, e as useControllableState, u as useId, j as createContext2, g as Presence, a as createContextScope, k as createSlot, d as useDirection, b as createCollection, l as createSlottable } from "./index-DGSilWL8.js";
...
function AdminArticleForm({ article, onClose }) {
  ...
  const [slug, setSlug] = reactExports.useState((article == null ? void 0 : article.slug) ?? "");
  const [excerpt, setExcerpt] = reactExports.useState((article == null ? void 0 : article.excerpt) ?? "");
  const [content, setContent] = reactExports.useState((article == null ? void 0 : article.content) ?? "");
  const [authorName, setAuthorName] = reactExports.useState((article == null ? void 0 : article.authorName) ?? "");
  const [category, setCategory] = reactExports.useState(
    (article == null ? void 0 : article.category) ?? Category.RawMill
  );
  const [status, setStatus] = reactExports.useState(
    (article == null ? void 0 : article.status) ?? ArticleStatus.draft
  );
  const [metaDescription, setMetaDescription] = reactExports.useState(
    (article == null ? void 0 : article.metaDescription) ?? ""
  );
  const [featuredImageUrl, setFeaturedImageUrl] = reactExports.useState(
    (article == null ? void 0 : article.featuredImageUrl) ?? ""
  );
  ...
  function handleSubmit(e) {
    e.preventDefault();
    const publishDate = (article == null ? void 0 : article.publishDate) ?? (/* @__PURE__ */ new Date()).toISOString();
    if (isEdit) {
      const input = {
        id: article.id,
        title,
      ...
      updateArticle(input, {
        ...
        onError: () => ue.error("Failed to update article")
      });
    } else {
      const input = {
        title,
      ...
      createArticle(input, {
        onSuccess: () => {
          ue.success("Article created");
          onClose();
        },
        onError: () => ue.error("Failed to create article")
      });
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display", children: isEdit ? "Edit Article" : "Create Article" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "title", className: "font-display text-sm", children: "Title" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "title",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "slug", className: "font-display text-sm", children: "Slug" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "slug",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "author", className: "font-display text-sm", children: "Author" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "author",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-display text-sm", children: "Category" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  value: category,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "admin.article_form.category_select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-display text-sm", children: "Status" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  value: status,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "admin.article_form.status_select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: ArticleStatus.draft, children: "Draft" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: ArticleStatus.published, children: "Published" })
                    ] })
                  ]
                }
              )
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "excerpt", className: "font-display text-sm", children: "Excerpt" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Textarea,
                {
                  id: "excerpt",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "content", className: "font-display text-sm", children: "Content (HTML)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Textarea,
                {
                  id: "content",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "meta", className: "font-display text-sm", children: "Meta Description" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "meta",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:col-span-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "image", className: "font-display text-sm", children: "Featured Image URL" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "image",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: isPending ? isEdit ? "Saving…" : "Creating…" : isEdit ? "Save Changes" : "Create Article"
              }
            )
          ] })
        ] })
...
function AdminDashboardPage() {
  ...
  const [editingArticle, setEditingArticle] = reactExports.useState(null);
  ...
  function handleDelete(id) {
    deleteArticle(id, {
      onSuccess: () => ue.success("Article deleted"),
      onError: () => ue.error("Failed to delete article")
    });
  }
  function handleLogout() {
    logout(void 0, {
      onSuccess: () => ue.success("Logged out")
    });
  }
  const articles = (listData == null ? void 0 : listData.articles) ?? [];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Manage CementHub articles and content" })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-6", "data-ocid": "admin.status_filters", children: [void 0, ArticleStatus.published, ArticleStatus.draft].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
              ...
              children: s === void 0 ? "All" : s === ArticleStatus.published ? "Published" : "Drafts"
            },
            s ?? "all"
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 rounded-lg" }, i))
                }
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-display", children: "No articles found." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        type: "button",
                        ...
                        children: "Create first article"
                      }
                    )
                  ]
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: articles.map((article, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-medium text-foreground truncate", children: article.title }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "admin.delete_dialog", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display", children: "Delete Article?" }),
    ...
    (showCreate || editingArticle) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      AdminArticleForm,
      {
        article: editingArticle ?? void 0,
        onClose: () => {
          setShowCreate(false);
